export async function onRequest(context) {
  ...
  const url = new URL(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${latitude}%2C${longitude}/${startDate}/${endDate}?unitGroup=metric&elements=datetime%2Ctemp%2Ctempmax%2Ctempmin%2Cwindspeed%2Csolarradiation%2Csunrise%2Csunset&include=days&key=${context.env.WEATHER_API_KEY}&contentType=json`);
